r"""Appendix 2 / IM–peak upstream material for the full paper.
...
2. Intensity measures — ``seiskit.intensity_measures`` (PGA, SA at \(T_0\), Arias \(I_a\))
...
4. 1D normalization — \(\chi^N = \chi / \chi^{\mathrm{1D}}\) → ratios in
   ...
   ``PSA_ratio`` [displayed as SA], ``Ia_ratio``)

SA period convention in this campaign: spectral ordinate at the 1D fundamental
