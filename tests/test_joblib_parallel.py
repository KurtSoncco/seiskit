...
def test_joblib_analysis_result_success_property():
    ...
    # Successful result
    result1 = JoblibAnalysisResult(task_id="test_task", status="Finished successfully")
    assert result1.success is True

    # Failed result with error
    result2 = JoblibAnalysisResult(task_id="test_task", status="Failed", error="Some error")
    assert result2.success is False

    # Failed result without error
    result3 = JoblibAnalysisResult(task_id="test_task", status="Failed")
...
def test_collect_joblib_results():
    ...
    results = [
        JoblibAnalysisResult(task_id="task1", status="Finished successfully", execution_time=10.0),
        JoblibAnalysisResult(
            task_id="task2", status="Failed", error="Some error", execution_time=5.0
        ),
        JoblibAnalysisResult(task_id="task3", status="Finished successfully", execution_time=15.0),
    ]
